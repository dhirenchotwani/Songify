                    ...
                    <View style={styles.searchContainer}>
                            ...
                            <View style={styles.songContainer}>
                                <Image source={{uri: this.props.screenProps.currentSong.thumbnail}}
                                  ...
                                  <View style={styles.infoContainer}>
                                      ...
                                      <Text style={styles.albumText}>{this.props.screenProps.currentSong.album} - {this.props.screenProps.currentSong.artist} </Text>
                        ...
                        <View style={styles.control}>
                            <Slider value={this.props.screenProps.position}
                                    ...
                                    minimumValue={0}
                                    maximumTrackTintColor={Colors.headingColor}
                                    minimumTrackTintColor={Colors.blueColor}
                                ...
                                <View style={styles.controlButtons}>
                                    ...
                                    <TouchableOpacity name={'dots-three-horizontal'} color={Colors.headingColor}
                                                    size={responsiveFontSize(3.5)}>
                                    </TouchableOpacity>
